...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['https://ubitec.online/', 'http://ubitec.online/', 'http://95.215.97.70', 'https://95.215.97.70'],            // If non-empty, requests not from an origin in this list will be blocked.
